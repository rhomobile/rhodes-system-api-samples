...
#define SWIG_init    Init_Rainbow
#define SWIG_name    "Rainbow"

static VALUE mRainbow;
...
SWIGINTERN VALUE
_wrap_open_native_view(int argc, VALUE *argv, VALUE self) {
  if ((argc < 0) || (argc > 0)) {
...
SWIGINTERN VALUE
_wrap_close_native_view(int argc, VALUE *argv, VALUE self) {
  if ((argc < 0) || (argc > 0)) {
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc); SWIG_fail;
  }
  close_native_view();
...
SWIGINTERN VALUE
_wrap_execute_command_in_native_view(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  int alloc1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","execute_command_in_native_view", 1, argv[0] ));
  }
  arg1 = (char *)(buf1);
  execute_command_in_native_view((char const *)arg1);
...
SWIGEXPORT void Init_RainbowRuby(void) {
  ...
  SWIG_InitRuntime();
  mRainbow = rb_define_module("Rainbow");
  ...
  rb_define_module_function(mRainbow, "open_native_view", _wrap_open_native_view, -1);
  rb_define_module_function(mRainbow, "close_native_view", _wrap_close_native_view, -1);
  rb_define_module_function(mRainbow, "execute_command_in_native_view", _wrap_execute_command_in_native_view, -1);
}
