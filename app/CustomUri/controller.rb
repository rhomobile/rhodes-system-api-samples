...
class CustomUriController < Rho::RhoController
  ...
  def install_app
    if System::get_property('platform') == 'Blackberry'
        ...
        System.open_url('itms-services://?action=download-manifest&url=http://rhohub-staging-ota.s3.amazonaws.com/4cd43fbe6e73b007ad000010/rhodes-system-api-samples-rhodes.plist')
    else
